...
- Name: roommate-finder.spec.js >> Roommate Finder — Page Structure >> "Back to Dashboard" and "View Watchlist" hero buttons are present
- Location: e2e/roommate-finder.spec.js:102:3
...
Locator: locator('button').filter({ hasText: 'Back to Dashboard' })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('button').filter({ hasText: 'Back to Dashboard' })
