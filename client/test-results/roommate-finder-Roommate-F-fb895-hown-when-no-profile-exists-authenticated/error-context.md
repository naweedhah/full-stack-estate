...
- Name: roommate-finder.spec.js >> Roommate Finder — Page Structure >> empty matches state message is shown when no profile exists
- Location: e2e/roommate-finder.spec.js:108:3
...
Call log:
  ...
  - waiting for locator('.emptyState')
