...
- Name: roommate-finder.spec.js >> Roommate Finder — Page Structure >> university dropdown contains valid options
- Location: e2e/roommate-finder.spec.js:94:3
...
Locator: locator('select[name="university"]')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('select[name="university"]')
