...
- Name: roommate-finder.spec.js >> Roommate Finder — Page Structure >> active match count shows 0 when there are no matches
- Location: e2e/roommate-finder.spec.js:55:3
...
Call log:
  ...
  - waiting for locator('.summaryCard')
