...
- Name: roommate-finder.spec.js >> Roommate Finder — Form Validation >> notes exceeding 300 characters shows an error
- Location: e2e/roommate-finder.spec.js:175:3
...
Call log:
  - waiting for locator('textarea[name="notes"]')
