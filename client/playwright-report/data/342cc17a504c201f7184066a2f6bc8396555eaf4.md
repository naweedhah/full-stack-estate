...
- Name: roommate-finder.spec.js >> Roommate Finder — Page Structure >> all required dropdowns are present in the form
- Location: e2e/roommate-finder.spec.js:71:3
...
Locator: locator('select[name="preferredCity"]')
Expected: visible
Timeout: 10000ms
