...
- Name: roommate-finder.spec.js >> Roommate Finder — Page Structure >> questionnaire form is rendered with all sections
- Location: e2e/roommate-finder.spec.js:62:3
...
Call log:
  ...
  - waiting for locator('.roommateForm')
